...
class EditNotePageState extends State<EditNotePage> {
  ...
  Future<void> getData() async {
    ...
    if(!mounted) return;
      await noteNotifier.getNote(noteId: widget.noteId);

    titleC.text = noteNotifier.note["parent_title"].toString();

    qc.document = Document.fromJson(json.decode(noteNotifier.note["content_json"]));
  }
  ...
  Future<void> updateNote() async {
    ...
    try {
      ...
      await context.read<NoteNotifier>().updateNote(
